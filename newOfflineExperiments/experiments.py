...
class Experiments:
    ...
    def storeExperimentOutput(self,experiment_name,usecase_name,accuracies,losses):
        ...
        # Store new usecase
        # Changed this to append instead of write
        with open('experiments/'+experiment_name+'.json', 'a') as outfile:
            exp = dict()
    ...
    # Experiment
    def runRandomVSFIFOReplayExperiment(self,experiment_name,usecase,replay_size=5000,random_selection=True):
        ...
        dataset = CORE50(root='C:/Users/nikol/Desktop/University/Year-4/ADE/ThesisCodeExperiments/CORe50-Dataset/core50_128x128/', scenario="nicv2_391", preload=False)
        ...
        accuracies = []
        losses = []
        # Used to copy the cl model head weights before compiling the model and then 
        # put the weights back to the cl model
    ...
    def runHiddenLayersExperiment(self, experiment_name, usecase, replay_size, random_selection, num_hidden_layers):
    ...
    def runHiddenLayerExperimentNew(self, experiment_name, usecase, replay_size, random_selection, num_hidden_layers):
        print("> Running Hidden Layers experiment")
